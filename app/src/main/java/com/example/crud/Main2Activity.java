...
public class Main2Activity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Esmeralda Reyes");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_limpiar) {
            ...
            Intent Acercade = new Intent(Main2Activity.this, AcercaDe.class);
    ...
    public String getSharedCodigo(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("EsmeraldaReyes", MODE_PRIVATE);
